...
# Hierarchical cell: xxv_eth_dma
proc create_hier_cell_xxv_eth_dma { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_xxv_eth_dma() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_xxv_eth
  ...
  # Create instance: sfp_tx_dis_1, and set properties
  set sfp_tx_dis_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant sfp_tx_dis_1 ]
  ...
  # Create instance: user_rx_rst_n, and set properties
  set user_rx_rst_n [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic user_rx_rst_n ]
  set_property -dict [list \
    CONFIG.C_OPERATION {not} \
    CONFIG.C_SIZE {1} \
  ] $user_rx_rst_n
  ...
  # Create instance: user_tx_rst_n, and set properties
  set user_tx_rst_n [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic user_tx_rst_n ]
  set_property -dict [list \
    CONFIG.C_OPERATION {not} \
    CONFIG.C_SIZE {1} \
  ] $user_tx_rst_n
  ...
  # Create instance: xxv_out_clk_sel_5, and set properties
  set xxv_out_clk_sel_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant xxv_out_clk_sel_5 ]
  set_property -dict [list \
    CONFIG.CONST_VAL {5} \
  ...
  # Create instance: xxv_tx_preamble_0, and set properties
  set xxv_tx_preamble_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant xxv_tx_preamble_0 ]
  set_property -dict [list \
    CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net S_AXI_LITE_0_1 [get_bd_intf_pins s_axi_lite_xxv_dma] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  ...
  connect_bd_net -net sfp_tx_dis_1_dout [get_bd_pins sfp_tx_dis_1] [get_bd_pins sfp_tx_dis_1/dout]
  ...
  connect_bd_net -net xxv_ethernet_0_user_rx_reset_0 [get_bd_pins user_rx_rst_n/Op1] [get_bd_pins xxv_ethernet_0/user_rx_reset_0]
  connect_bd_net -net xxv_ethernet_0_user_tx_reset_0 [get_bd_pins user_tx_rst_n/Op1] [get_bd_pins xxv_ethernet_0/user_tx_reset_0]
  connect_bd_net -net xxv_out_clk_sel_5_dout [get_bd_pins xxv_ethernet_0/rxoutclksel_in_0] [get_bd_pins xxv_ethernet_0/txoutclksel_in_0] [get_bd_pins xxv_out_clk_sel_5/dout]
  connect_bd_net -net xxv_tx_preamble_0_dout [get_bd_pins xxv_ethernet_0/tx_preamblein_0] [get_bd_pins xxv_tx_preamble_0/dout]
...
proc create_root_design { parentCell } {
  ...
  set M_XXV_DMA_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_XXV_DMA_AXI ]
  set_property -dict [ list \
  ...
  set axi_interconnect_ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect axi_interconnect_ps ]
  set_property -dict [list \
  ...
  # Create instance: xxv_eth_dma
  create_hier_cell_xxv_eth_dma [current_bd_instance .] xxv_eth_dma
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {######UART 0#UART 0######SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#######################################################} \
    CONFIG.PSU_MIO_TREE_SIGNALS {######rxd#txd######sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#######################################################}\
\
...
\
  ...
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces xxv_eth_dma/axi_dma_0/Data_MM2S] [get_bd_addr_segs M_XXV_DMA_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces xxv_eth_dma/axi_dma_0/Data_S2MM] [get_bd_addr_segs M_XXV_DMA_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces xxv_eth_dma/axi_dma_0/Data_SG] [get_bd_addr_segs M_XXV_DMA_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces S_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x60100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_MMIO_AXI] [get_bd_addr_segs xxv_eth_dma/axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x60110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_MMIO_AXI] [get_bd_addr_segs xxv_eth_dma/xxv_ethernet_0/s_axi_0/Reg] -force
